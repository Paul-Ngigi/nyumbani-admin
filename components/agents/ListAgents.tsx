  ...
  return (
    <>
      <div className="flex flex-col md:flex-row md:justify-between items-center">
        <Input placeholder="Search agent..." className="max-w-sm" />
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            className="ml-auto"
            onClick={() => router.push("agents/add-agent")}
          >
            Add Agent <IoPersonAddSharp className="ml-2 h-4 w-4" />
          </Button>
...
const fetchAgents = async (data: any) => {
